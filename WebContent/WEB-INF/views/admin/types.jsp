		...
		<nav id="sidebar">
			<div class="p-4 pt-5">
				...
				<ul class="list-unstyled components mb-5">
					...
					<li><a href="categories.htm">Mặt Hàng</a></li>
					<li class="active"><a href="types.htm">Loại Nước</a></li>
									...
									<table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <th><input type="text" placeholder="ID" name="idtype"></th>
                                                <th><input type="text" placeholder="Name" name="nametype"></th>
                                                <th>
