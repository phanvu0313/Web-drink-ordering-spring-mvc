...
/* API Zozo */
function floatToString(a,r){var t = a.toFixed(r).toString();return t.replace(".", Zozo.decimal), t.match("^[." + Zozo.decimal + "]d+") ? "0" + t : t}function attributeToString(a) {return "string" != typeof a && (a += "", "undefined" === a && (a = "")), jQuery.trim(a)}

/* Selection Zozo */
if ("undefined" == typeof Zozo) var Zozo = {};
Zozo.cultures = [
    {
        code         : "vi-VN",
        thousands    : ",",
...
Zozo.getCulture = function (t) {
    var e;
    for (n = 0; n < Zozo.cultures.length; n++) if (Zozo.cultures[n].code == t) {
        e = Zozo.cultures[n];
        break
    }
    return e || (e = Zozo.cultures[0]), e
};
Zozo.format = Zozo.getCulture(Zozo.culture);
Zozo.money_format = "", Zozo.each = function (t, e) {
    for (var a = 0; a < t.length; a++) e(t[a], a)
};
Zozo.map = function (t, e) {
    for (var a = [], r = 0; r < t.length; r++) a.push(e(t[r], r));
    return a
};
Zozo.arrayIncludes = function (t, e) {
    for (var a = 0; a < t.length; a++) if (t[a] == e) return !0;
    return !1
};
Zozo.uniq = function (t) {
    for (var e = [], a = 0; a < t.length; a++) Zozo.arrayIncludes(e, t[a]) || e.push(t[a]);
    return e
};
Zozo.isDefined = function (t) {
    return "undefined" != typeof t
};
Zozo.getClass = function (t) {
    return Object.prototype.toString.call(t).slice(8, -1)
};
Zozo.extend = function (t, e) {
    function a() {}
...
Zozo.urlParam = function (t) {
    var e = RegExp("[?&]" + t + "=([^&]*)").exec(window.location.search);
    return e && decodeURIComponent(e[1].replace(/\+/g, " "))
};
Zozo.Product = function (t) {
    Zozo.isDefined(t) && this.update(t)
};
Zozo.Product.prototype.update = function (t) {
    for (property in t) this[property] = t[property]
};
Zozo.Product.prototype.optionNames = function () {
    return "Array" == Zozo.getClass(this.options) ? this.options : []
};
Zozo.Product.prototype.optionValues = function (t) {
    if (!Zozo.isDefined(this.variants)) return null;
    var e = Zozo.map(this.variants, function (e) {
        var a = "option" + (t + 1);
        return void 0 == e[a] ? null : e[a]
    });
    return null == e[0] ? null : Zozo.uniq(e)
};
Zozo.Product.prototype.getVariant = function (t) {
    var e = null;
    return t.length != this.options.length ? e : (Zozo.each(this.variants, function (a) {
...
Zozo.Product.prototype.getVariantById = function (t) {
...
Zozo.formatMoney = function (t, e) {
    function a(t) {
        return t.replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1" + Zozo.format.thousands)
    }
    t /= 100, "string" == typeof t && (t = t.replace(Zozo.format.thousands, ""));
    var r = "",
        n = /\{\{\s*(\w+)\s*\}\}/,
        o = e || this.money_format;
    switch (o.match(n)[1]) {
        case"amount":
            r = a(floatToString(t, Zozo.format.numberdecimal));
            break;
        case"amount_no_decimals":
            r = a(floatToString(t, 0));
            break;
        case"amount_with_comma_separator":
            r = floatToString(t, Zozo.format.numberdecimal).replace(/\./, ",");
            break;
...
Zozo.OptionSelectors = function (t, e) {
    return this.selectorDivClass = "selector-wrapper", this.selectorClass = "single-option-selector", this.variantIdFieldIdSuffix = "-variant-id", this.variantIdField = null, this.historyState = null, this.selectors = [], this.domIdPrefix = t, this.product = new Zozo.Product(e.product), this.onVariantSelected = Zozo.isDefined(e.onVariantSelected) ? e.onVariantSelected : function () {}, this.replaceSelector(t), this.initDropdown(), e.enableHistoryState && (this.historyState = new Zozo.OptionSelectors.HistoryState(this)), !0
};
Zozo.OptionSelectors.prototype.initDropdown = function () {
    var t = {initialLoad: !0},
...
Zozo.OptionSelectors.prototype.fireOnChangeForFirstDropdown = function (t) {
    !this.selectors && !this.selectors.length && this.selectors.length > 0 && this.selectors[0].element.onchange(t)
};
Zozo.OptionSelectors.prototype.selectVariantFromParamsOrDropdown = function (t) {
    var e = this.selectVariantFromParams(t);
    e || this.selectVariantFromDropdown(t)
};
Zozo.OptionSelectors.prototype.replaceSelector = function (t) {
    var e = document.getElementById(t);
    if (null != e) {
        var a = e.parentNode;
        Zozo.each(this.buildSelectors(), function (t) {
            a.insertBefore(t, e)
        }), e.style.display = "none", this.variantIdField = e
    }
};
Zozo.OptionSelectors.prototype.selectVariantFromDropdown = function (t) {
...
Zozo.OptionSelectors.prototype.selectVariantFromParams = function (t) {
    var e = Zozo.urlParam("variant");
    return this.selectVariant(e, t)
};
Zozo.OptionSelectors.prototype.selectVariant = function (t, e) {
...
Zozo.OptionSelectors.prototype.optionExistInSelect = function (t, e) {
    for (var a = 0; a < t.options.length; a++) if (t.options[a].value == e) return !0
};
Zozo.OptionSelectors.prototype.insertSelectors = function (t, e) {
    Zozo.isDefined(e) && this.setMessageElement(e), this.domIdPrefix = "product-" + this.product.id + "-variant-selector";
    var a = document.getElementById(t);
    return a ? void Zozo.each(this.buildSelectors(), function (t) {
        a.appendChild(t)
    }) : !1
};
Zozo.OptionSelectors.prototype.buildSelectors = function () {
    for (var t = 0; t < this.product.optionNames().length; t++) {
        var e = new Zozo.SingleOptionSelector(this, t, this.product.optionNames()[t], this.product.optionValues(t));
        e.element.disabled = !1, this.selectors.push(e)
    }
    var a = this.selectorDivClass,
        r = this.product.optionNames(),
        n = Zozo.map(this.selectors, function (t) {
...
Zozo.OptionSelectors.prototype.selectedValues = function () {
...
Zozo.OptionSelectors.prototype.updateSelectors = function (t, e) {
...
Zozo.OptionSelectorsFromDOM = function (t, e) {
    var a = e.optionNames || [],
        r = e.priceFieldExists || !0,
        n = e.delimiter || "/",
        o = this.createProductFromSelector(t, a, r, n);
    e.product = o, Zozo.OptionSelectorsFromDOM.baseConstructor.call(this, t, e)
};
Zozo.extend(Zozo.OptionSelectorsFromDOM, Zozo.OptionSelectors);
Zozo.OptionSelectorsFromDOM.prototype.createProductFromSelector = function (t, e, a, r) {
    if (!Zozo.isDefined(a)) var a = !0;
    if (!Zozo.isDefined(r)) var r = "/";
    var n = document.getElementById(t);
    if (!n) return !1;
    var o = n.childNodes,
        i = (n.parentNode, e.length),
        s = [];
    Zozo.each(o, function (t) {
...
Zozo.SingleOptionSelector = function (t, e, a, r) {
...
Zozo.OptionSelectors.HistoryState = function (t) {
    this.browserSupports() && this.register(t)
};
Zozo.OptionSelectors.HistoryState.prototype.register = function (t) {
    window.addEventListener("popstate", function () {
        t.selectVariantFromParamsOrDropdown({popStateCall: !0})
    })
};
Zozo.OptionSelectors.HistoryState.prototype.onVariantChange = function (t, e, a) {
    this.browserSupports() && (!t || a.initialLoad || a.popStateCall || window.history.pushState({}, document.title, "?variant=" + t.id))
};
Zozo.OptionSelectors.HistoryState.prototype.browserSupports = function () {
